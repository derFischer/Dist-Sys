...
func TestRejoin2B(t *testing.T) {
	...
	leader1 := cfg.checkOneLeader()
	//fmt.Printf("dddddddddddddddddddddddddddddddddddddddddddddddddddisconnect server %d\n", leader1)
	cfg.disconnect(leader1)
	...
	//fmt.Printf("ccccccccccccccccccccccccccccccccccccccccccccccccccccccccconnect server %d\n", leader1)
	cfg.connect(leader1)
